...
from prfpy_csenf.model import Iso2DGaussianModel, DoG_Iso2DGaussianModel, CSS_Iso2DGaussianModel, Norm_Iso2DGaussianModel
from prfpy_csenf.fit import Iso2DGaussianFitter, DoG_Iso2DGaussianFitter, CSS_Iso2DGaussianFitter,Norm_Iso2DGaussianFitter
...
Args:
    ...
    -m (--model=)       model to fit: norm, css, or dog
    ...
    --tc                use trust-constraint optimiser
    --bgfs              use L-BFGS-B optimiser (default)
...
---------------------------------------------------------------------------------------------------
    ...
    iter_gauss = dag_find_file_in_folder([sub, 'gauss', roi_fit, 'iter', task, constraints, '.pkl'], output_dir, return_msg=None)        
    if iter_gauss is None:
        ...
        iter_gauss = dag_find_file_in_folder([sub, 'gauss', 'all', 'iter', task, 'bgfs', '.pkl'], output_dir, return_msg=None)        
        print('**** USING ALL *****')
